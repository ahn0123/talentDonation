...
<html>
<head>
    <title>PTA PROGRAMAPPLYLIST</title>
    <meta charset="utf-8" />
						...
						<table>
							...
							<tbody>
								...
								<tr>
									...
									<td style="text-align:center;"><a href="programApplyDetail?progId=${list.progId}&memId=${sessionId}">${list.progTitle}</a></td>
...
$(".changePage").on("click", function(e){
    ...
    moveForm.attr("action", "/program/programApplyList")
    moveForm.submit();
